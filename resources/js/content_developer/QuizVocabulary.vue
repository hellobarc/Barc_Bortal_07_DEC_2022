        ...
        <div class="row">
            <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                <div class="mt-5 mb-5" style="display:flex;justify-content: space-between; ">
                    <button class="button_back">  <router-link :to="'/content/lesson/6'"> <i class="bi bi-arrow-left"></i>  Back to Lesson  </router-link></button>
                ...
                <div class="reading_wrapper">
                    <div class="reading-title">
                            Vocabulary : {{lesson_detail.course_name}} : {{lesson_detail.unit_name}}
                    </div>
                    <div class="inner_content">
                        ...
                        <div class="passage_content">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                                        <div class="ans_options inline_content">
                                            <div v-for="ans in inputs_fillblank">
                                                <div v-if="ans.element_type === 'text'" >
                                                    <div v-html="ans.value"></div>
                                                </div>
                                                ...
                                                <div v-if="ans.element_type=='enter'">
                                                   <div v-html="para"></div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        ...
                                        <div class="fill_blank">
                                            <div class="my-5">
                                                <button class="simple_button_1 mx-2" @click.prevent="addText"><i class="bi bi-plus-circle-fill"></i> Add Text</button>
                                                <button class="simple_button_1 mx-2" @click.prevent="addInput"><i class="bi bi-plus-circle-fill"></i> Add Blank</button>
                                                <button class="simple_button_1 mx-2" @click.prevent="addSerial"><i class="bi bi-plus-circle-fill"></i> Add Serial</button>
                                                <button class="simple_button_1 mx-2" @click.prevent="addEnter"><i class="bi bi-plus-circle-fill"></i> Add Enter</button>
                                            </div>
...
export default {
  ...
  methods: {
    ...
    addText(){
      this.inputs_fillblank.push({value:'',element_type:'text'});
    },
    addInput(){
      this.inputs_fillblank.push({value:'',element_type:'input'});
    },
    addSerial(){
        this.serial+=1;
        this.inputs_fillblank.push({value:this.serial,element_type:'serial'});
    },
    addEnter(){
        this.inputs_fillblank.push({value:'',element_type:'enter'});
    },
